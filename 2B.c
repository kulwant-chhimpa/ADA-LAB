...
#include <Ɵme.h>
// FuncƟon to swap
elements void swap(int* a,
int* b) { int temp = *a;
*a = *b;
*b = temp;
}
// ParƟƟon funcƟon using the last element as
pivot int parƟƟon(int arr[], int low, int high) {
...
if(low < high) { int pi = parƟƟon(arr,
